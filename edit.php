...
<body>
  ...
  <form action="blog_update.php" method="POST">
    ...
    <br />
    <input type="radio" name="publish_status" value="1" checked <?php if ($category === 1) echo 'checked' ?> />公開
    <input type="radio" name="publish_status" value="2" <?php if ($category === 2) echo 'checked' ?> />非公開
    <br />
